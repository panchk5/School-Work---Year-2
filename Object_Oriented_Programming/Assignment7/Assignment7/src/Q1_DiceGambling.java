...
class Gambler {
    ...
    static boolean gambling(Gambler gambler_1, Gambler gambler_2, int stake) {
        ...
        while (!winner){
            int die1 = gambler_1.die.rollDice();
            System.out.println("Gambler one rolled: " + die1);
            int die2 = gambler_2.die.rollDice();
            System.out.println("Gambler two rolled: " + die2);
            if (die1 > die2){
                gambler_1.money = gambler_1.money + stake;
                gambler_2.money = gambler_2.money - stake;
                System.out.println("Gambler one won!");
                winner = true;
            }else if(die1 < die2){
                gambler_2.money = gambler_2.money + stake;
                gambler_1.money = gambler_1.money - stake;
                System.out.println("Gambler two won!");
                winner = true;
            }
        }
...
public class Q1_DiceGambling {
    ...
    public static void keepGambling(Gambler gambler_1, Gambler gambler_2, int stake, int max_gambling_times) {
        /* place your code here */
        while (max_gambling_times > 0){
            max_gambling_times--;
            boolean ans = Gambler.gambling(gambler_1,gambler_2,stake);
